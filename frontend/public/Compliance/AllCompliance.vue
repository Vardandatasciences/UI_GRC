        ...
        <div class="compliance-card-grid">
          <div v-for="fw in frameworks" :key="fw.id" class="compliance-card" @click="selectFramework(fw)">
            ...
            <div class="compliance-card-content">
              ...
              <div class="compliance-card-desc" :title="fw.description">{{ truncateDescription(fw.description) }}</div>
        ...
        <div class="compliance-card-grid">
          <div v-for="policy in policies" :key="policy.id" class="compliance-card" @click="selectPolicy(policy)">
            ...
            <div class="compliance-card-content">
              ...
              <div class="compliance-card-desc" :title="policy.description">{{ truncateDescription(policy.description) }}</div>
              <div class="compliance-version-info">
        ...
        <div v-else-if="viewMode === 'card'" class="compliance-grid">
          <div v-for="compliance in filteredCompliances" 
            ...
            <div class="compliance-body">
              ...
              <div class="compliance-card-desc" :title="compliance.description">
                {{ truncateDescription(compliance.description) }}
              </div>
              <div v-if="compliance.info" class="compliance-card-info" :title="compliance.info">
                {{ truncateDescription(compliance.info) }}
              </div>
