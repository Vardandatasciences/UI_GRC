...
# Notification endpoints
    ...
    # RBAC Test endpoints for verifying permissions
    path('api/test-policy-view/', rbac_views.test_policy_view_permission, name='test-policy-view-permission'),
    path('api/test-policy-create/', rbac_views.test_policy_create_permission, name='test-policy-create-permission'),
    path('api/test-policy-approve/', rbac_views.test_policy_approve_permission, name='test-policy-approve-permission'),
    ...
    path('api/test-any-permission/', rbac_views.test_any_permission, name='test-any-permission'),
    path('api/test-all-permissions/', rbac_views.test_all_permissions, name='test-all-permissions'),
    path('api/test-endpoint-permission/', rbac_views.test_endpoint_permission, name='test-endpoint-permission'),
