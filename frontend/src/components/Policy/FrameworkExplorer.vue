<template>
  <div class="framework-explorer-container">
      ...
      <div class="summary-card active-framework" @click="filterByStatus('Active', 'framework')">
        <div class="summary-card-content">
          <div class="summary-icon-label">
            ...
            <div class="summary-label">Active Framework</div>
          </div>
      ...
      <div class="summary-card inactive-framework" @click="filterByStatus('Inactive', 'framework')">
        <div class="summary-card-content">
          <div class="summary-icon-label">
            ...
            <div class="summary-label">Inactive Framework</div>
          </div>
      ...
      <div class="summary-card active-policy" @click="filterByStatus('Active', 'policy')">
        <div class="summary-card-content">
          <div class="summary-icon-label">
            ...
            <div class="summary-label">Active Policy</div>
          </div>
      ...
      <div class="summary-card inactive-policy" @click="filterByStatus('Inactive', 'policy')">
        <div class="summary-card-content">
          <div class="summary-icon-label">
            ...
            <div class="summary-label">Inactive Policy</div>
          </div>
    ...
    <div v-if="showModal" class="modal-overlay" @click="closeModal">
      <div class="modal-content simple-modal" @click.stop>
        <button class="modal-close-btn simple-close" @click="closeModal">&times;</button>
        ...
        <div v-else-if="frameworkDetails" class="modal-body simple-modal-body">
          <div class="framework-details simple-framework-details">
            <div class="detail-row simple-detail-row">
              <span class="detail-label simple-detail-label">Framework Name</span>
              <span class="detail-value simple-detail-value">{{ frameworkDetails.FrameworkName }}</span>
            </div>
            <div class="detail-row simple-detail-row">
              <span class="detail-label simple-detail-label">Description</span>
              <span class="detail-value simple-detail-value">{{ frameworkDetails.FrameworkDescription }}</span>
            </div>
            <div class="detail-row simple-detail-row">
              <span class="detail-label simple-detail-label">Category</span>
              <span class="detail-value simple-detail-value">{{ frameworkDetails.Category }}</span>
            </div>
            <div class="detail-row simple-detail-row">
              <span class="detail-label simple-detail-label">Version</span>
              <span class="detail-value simple-detail-value">{{ frameworkDetails.CurrentVersion }}</span>
            </div>
            <div class="detail-row simple-detail-row">
              <span class="detail-label simple-detail-label">Status</span>
              <span class="detail-value simple-detail-value">{{ frameworkDetails.Status }}</span>
            </div>
            <div class="detail-row simple-detail-row">
              <span class="detail-label simple-detail-label">Active/Inactive</span>
              <span class="detail-value simple-detail-value">{{ frameworkDetails.ActiveInactive }}</span>
            </div>
            <div class="detail-row simple-detail-row">
              <span class="detail-label simple-detail-label">Identifier</span>
              <span class="detail-value simple-detail-value">{{ frameworkDetails.Identifier }}</span>
            </div>
            <div class="detail-row simple-detail-row">
              <span class="detail-label simple-detail-label">Effective Date</span>
              <span class="detail-value simple-detail-value">{{ formatDate(frameworkDetails.EffectiveDate) }}</span>
            </div>
            <div class="detail-row simple-detail-row">
              <span class="detail-label simple-detail-label">Start Date</span>
              <span class="detail-value simple-detail-value">{{ formatDate(frameworkDetails.StartDate) }}</span>
            </div>
            <div class="detail-row simple-detail-row">
              <span class="detail-label simple-detail-label">End Date</span>
              <span class="detail-value simple-detail-value">{{ formatDate(frameworkDetails.EndDate) }}</span>
            </div>
            <div class="detail-row simple-detail-row">
              <span class="detail-label simple-detail-label">Created By</span>
              <span class="detail-value simple-detail-value">{{ frameworkDetails.CreatedByName }}</span>
            </div>
            <div class="detail-row simple-detail-row">
              <span class="detail-label simple-detail-label">Created Date</span>
              <span class="detail-value simple-detail-value">{{ formatDate(frameworkDetails.CreatedByDate) }}</span>
            </div>
            <div class="detail-row simple-detail-row" v-if="frameworkDetails.DocURL">
              <span class="detail-label simple-detail-label">Documentation</span>
              <a :href="frameworkDetails.DocURL" target="_blank" class="doc-link simple-detail-value">View Documentation</a>
            </div>
          </div>
        </div>
...
.summary-card {
  ...
  text-align: center;
  min-width: 0;
  max-width: 170px; /* reduce max-width */
  min-height: 80px;
