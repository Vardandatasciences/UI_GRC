    ...
    <div class="incident-list-wrapper">
      ...
      >
        ...
        <template #actions="{ row }">
          ...
          <div v-else-if="row.Status === 'Under Review' || row.Status === 'PENDING REVIEW'">
            Pending Review
          </div>
          ...
          <div v-else-if="row.Status === 'Open' || !row.Status || row.Status.trim() === ''">
            <div class="incident-actions-container">
              <button 
                ...
                @click="handleDropdownAction('assign', row)"
                title="Assign as Incident"
                v-if="canAssignIncident()"
              >
                <i class="fas fa-user-plus"></i>
              </button>
              <button 
                class="incident-action-icon"
                @click="handleDropdownAction('escalate', row)"
                title="Escalate to Risk"
                v-if="canEscalateIncident()"
              >
