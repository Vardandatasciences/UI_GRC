    ...
    <div class="incident-form-box">
      <form @submit.prevent="validateAndSubmit" class="incident-create-form">
        ...
        <label class="field-third">
          ...
          />
          <div class="field-helper-tip">
            Specify the geographic location where the incident occurred (e.g., New York Office, London Branch, Remote/Cloud, Data Center - Dallas...)
          </div>
        ...
        <label class="field-third">
          ...
          />
          <div class="field-helper-tip">
            List the systems, applications, or assets involved in the incident (e.g., Customer CRM, Payment Gateway, Email Server, Database XYZ, Network Infrastructure...)
          </div>
