  ...
  <div class="policy-tabs-container single-container">
    ...
    <template v-if="!selectedFramework">
      <template v-if="activeTab==='framework'">
        ...
        <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; max-width:260px; margin:0 auto 8px auto;">
          <CustomDropdown
          ...
          />
          <div class="dropdown-helper-text">Select a framework to view its policies and subpolicies.</div>
        </div>
        <div class="section-header" style="margin-bottom:8px;">Frameworks</div>
          ...
          <div v-for="fw in filteredFrameworks" :key="fw.id" class="card" @click="selectFramework(fw)">
            <div class="card-header">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                <div class="card-status" :class="statusClass(fw.status)" style="margin-right: auto;">{{ fw.status }}</div>
        ...
        <div v-if="policyViewMode === 'card'" class="card-grid">
          <div v-for="policy in filteredPolicies" :key="policy.id" class="card">
            <div class="card-header">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                <div class="card-status" :class="statusClass(policy.status)" style="margin-right: auto;">{{ policy.status }}</div>
        ...
        <div v-if="subpolicyViewMode === 'card'" class="card-grid">
          <div v-for="subpolicy in filteredSubpolicies" :key="subpolicy.id" class="card">
            <div class="card-header">
              ...
              <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                <div class="card-status" :class="statusClass(subpolicy.status)" style="margin-right: auto;">{{ subpolicy.status }}</div>
      ...
      <div class="card-grid">
        <div v-for="version in selectedFramework.versions" :key="version.id" class="card" @click="selectFrameworkVersion(version)">
          <div class="card-header">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
              <div class="card-status" :class="statusClass(version.status)" style="margin-right: auto;">{{ version.status }}</div>
      ...
      <div class="card-grid">
        <div v-for="sub in selectedPolicyVersion.subpolicies" :key="sub.id" class="card">
          <div class="card-header">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
              <div class="card-status" :class="statusClass(sub.status)" style="margin-right: auto;">{{ sub.status }}</div>
